/* Conway's Life behind the hero, in four species — the classic page's
   weather, unchanged in behavior and now a module of its own so the voyage
   build never pays for it and the classic build never pays for the voyage.
   See README for the full story of the rules and constants.
...
export function startLife(hero) {
  return new Life(hero);
}
