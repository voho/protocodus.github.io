...
const GLYPHS = {
  ...
  '!': [0x00, 0x00, 0x5f, 0x00, 0x00],  // the milestone banners end in one
  '&': [0x36, 0x49, 0x55, 0x22, 0x50],  // the pause screen's "CARVE & SPIN"
  ...
  // The pointer pair exists at two codepoints (U+25C0/25B6 and U+25C4/25BA)
  // and the HUD's edge-of-piste arrows arrive as the second — which drew as
  // tofu boxes beside the word PISTE until these aliases.
  '◄': [0x08, 0x1c, 0x3e, 0x7f, 0x00],
  '►': [0x00, 0x7f, 0x3e, 0x1c, 0x08],
  '▲': [0x20, 0x30, 0x38, 0x30, 0x20],
  '▼': [0x04, 0x0c, 0x1c, 0x0c, 0x04],
  '✦': [0x08, 0x1c, 0x77, 0x1c, 0x08],
  '←': [0x08, 0x1c, 0x2a, 0x08, 0x08],
  'Ⅱ': [0x00, 0x7f, 0x00, 0x7f, 0x00],
  '♪': [0x60, 0x50, 0x4f, 0x00, 0x00],
};
