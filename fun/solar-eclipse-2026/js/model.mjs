export const LOCATIONS = Object.freeze({
  ...
  leon: Object.freeze({
    ...
    latitude: 42.5987,
    longitude: -5.5671,
    start: 19 * 60 + 32 + 41.6 / 60,
    maximum: 20 * 60 + 29 + 8.2 / 60,
    end: 21 * 60 + 22 + 3.1 / 60,
    geometricEnd: 21 * 60 + 22 + 3.1 / 60,
    totalityStart: 20 * 60 + 28 + 15.5 / 60,
    totalityEnd: 20 * 60 + 30 + 2.6 / 60,
    maxCoverage: 1,
    magnitude: 1.013,
    moonRadius: 1.0386,
    kind: 'total',
  ...
  london: Object.freeze({
    ...
    latitude: 51.5072,
    longitude: -0.1276,
    start: 18 * 60 + 17 + 16.5 / 60,
    maximum: 19 * 60 + 13 + 15.6 / 60,
    end: 20 * 60 + 6 + 16.4 / 60,
    geometricEnd: 20 * 60 + 6 + 16.4 / 60,
    maxCoverage: 0.914,
    magnitude: 0.925,
    moonRadius: 1.022,
    kind: 'partial',
