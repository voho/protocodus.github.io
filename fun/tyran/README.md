...
- Progress saves automatically every five seconds of flight, when pausing or leaving, at each sector launch/clear, after shop purchases, and at campaign completion. Stage, credits, score, equipment and solo/co-op mode are included. Each pilot's energy, recharge delay and depleted state are saved independently.
