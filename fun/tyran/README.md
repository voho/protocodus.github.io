...
- **Single player:** WASD to move; **Space** fires primary pulse, **Q** fires secondary plasma.
- **Pause:** Escape, P or Tab. **Sound:** V. Sound and effects quality are also available in the pause menu.
- **Weapons:** your ship carries Pulse Array and Plasma Mortar. Each fire key uses its own weapon directly; there is no weapon-switch key. The six-tier Ion armament upgrade improves both weapons.
