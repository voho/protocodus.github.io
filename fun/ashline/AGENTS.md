...
The playable races are **Organics** and **AI Unity**. Organics combines humans and alien infantry with clunky utilitarian machinery inspired by 1960s industrial and Soviet equipment. Make its age apparent in the major shapes: bulbous cast turrets, rounded truck cabins, broad fenders, cylindrical tanks, domed housings, arched industrial roofs, exposed pipes, analog communications equipment, practical cranes and substantial running gear. It should look round, heavy, obsolete and mechanically serviceable. Use restrained wear that preserves bright faction armor and clear silhouettes. AI Unity uses robots instead of soldiers, intricate technical assemblies, segmented machine bodies, precision walker joints, and distinctive automated architecture. The races need different silhouettes and materials at normal zoom, not only different names or paint. Keep larger mechanical relationships readable when zoomed out. Friendly/hostile faction paint and square/diamond ownership badges remain independent of race. All designs are original; use industrial references rather than copied franchise assets or insignia.

Ashline is an original 2D military science-fiction RTS set on a desolate volcanic frontier. Units and buildings use smooth, refined military-miniature sprites: functional machinery, broad armor plates, graphite mechanisms, clear faction paint, sparse amber work lights, and controlled bevel highlights. Use enough texture resolution for the actual unit size and high-density displays, with smooth contours and restrained mechanical detail. Major shapes must remain clear at minimum zoom. Avoid pixel-art blocks, high-resolution photographic noise, tiny rivets, dense scratches, and detail that becomes blur when reduced. Friendly forces use bright ivory armor with cobalt panels; enemy forces use broad crimson armor with pale warm highlights. The mood is rugged, tactical, and atmospheric, with original branding and designs.
...
The current unit pipeline uses overhead source atlases, rotates each unit on the ground plane, then applies the same shallow projection and side depth to every heading. Keep projection after heading rotation. Do not restore the old mixture of independently angled directional sprites. Source textures may be strictly overhead; the final in-game view must retain the requested small amount of side depth. Prepare unit frames at 64–128 pixels and building frames at 80–208 pixels, approximately twice the earlier logical frame sizes, rather than repeatedly drawing huge source atlas cells. Use high-quality filtered normalization and smooth final sprite sampling for roofs, rotation, zoom, portraits, and production previews. Preserve continuous headings and stable anchors. Terrain, fog, light effects, and soft shadows retain their separate rendering.

The terrain consists of charcoal/taupe ash, basalt, slate dust, fractured rock, subdued rust deposits, and luminous mint mineral crystals. Surface detail should remain quiet enough for armies to read immediately. Keep unit and building proportions grounded and major equipment recognizable. Avoid cartoon proportions, vector-icon simplification, low-poly facets, thick ink outlines, excessive bloom, or pervasive neon lighting.

Relief comes from the simulation's seeded value noise, never from per-tile randomness: coherent ridge walls with gaps, mesas, sunken basalt basins (terrain type 2), a broken plateau ring around each base, open bowls around mineral fields, and mirrored boulder outcrops. Impassable rock must read as raised ground at every zoom: a lighter plate a few levels above the ash, an upper-left rim light, a short lower-edge wall, and a soft lower-right foot shadow, with boulder props concentrated on formation edges. Basalt reads as a slightly sunken, cooler and smoother plate with fine joint seams; it stays passable and must keep ivory and crimson units readable. Haul ruts only cross open ground. Keep the relief point-symmetric about the map centre so both bases face the same terrain, and never leave a sealed pocket of thirty or more tiles.

Lava pools lie within the same ground plane: irregular rounded basalt shores surrounding broad red/orange molten surfaces, yellow-hot folds, and sparse pale amber bubbles. Dark cooling crust is secondary; the pool must read as hot liquid rather than black ground with thin cracks. Slowly move the molten texture through a fixed shoreline using simulation time, with quiet surface motion and restrained local highlights. Keep banks grounded in the surrounding ash; avoid hard grid-shaped edges or large glowing halos. Lava must remain clearly different from mint mineral deposits, with nearby ivory units and faction markings easy to identify. Unexplored lava stays hidden, and remembered pools show no live motion outside current vision.

Deadwood adds botanical variety without overtaking the military silhouettes: bare broad-crowned hardwoods, charred conifers, twisted wind-bent trees, ash-bleached forked snags, hollow stumps, and fallen trunks. Use dry taupe, muted grey-brown, graphite char, and small ochre splinters; bleached bark stays darker than ivory unit armor. Keep branching open and substantial enough to read at minimum zoom. Source crowns are overhead layers, prepared with the same fixed shallow projection as unit roofs; never rotate the camera or turn these props into tall side-elevation portraits. Scatter individual trees randomly across open ground with seeded positions and varied silhouettes. Give roots a clear obstructed footprint while keeping mineral access, guaranteed routes, and base construction clearings open. Older saves retain their original rocky groves. Soft shadows fall lower-right. Canopies may fade for visible units behind them; concealed units must never affect tree opacity.

Minerals form loose irregular patches with gaps, small satellite deposits, and varied outlines. Avoid identical dense circular clusters or rigid rows. Preserve readable mint crystal silhouettes and comparable resource quantities and access for both teams. New layouts are seeded; saved mineral positions and depletion stay unchanged when loading.

Expansion deposits also use blue crystals and dense red crystals. Red deposits contain twice the credits and extract twice as quickly; all mineral colors feed the same credit economy. Keep red minerals pink-red with pale crystal highlights, clearly separate from broad crimson military armor and orange lava. Blue minerals use icy blue highlights, distinct from cobalt faction panels. Cargo and refinery hoppers reflect delivered mineral types; old saves retain mint deposits. Terrain profiles (rift, basin, highlands) change coherent relief and resource placement while keeping mirrored access. New maps offer 144×112, 192×144, and 224×168 tiles.

Crater floors (terrain type 5) are passable and give units 15% cover from direct fire, but cannot support construction. Rockets and siege blasts bypass that cover. Render broad shallow depressions with broken rounded rims, quiet floors and consistent upper-left lighting, distinct from raised rock and molten pools. Craters must preserve mineral access, start clearings and guaranteed routes. Their placement and mirrored geometry are seeded, with no animated behavior hidden under fog.
...
| Lava | Red/orange molten body, broad hot orange and yellow folds, amber highlights `#ffce5b`, secondary charcoal cooling crust `#2f2924` |
...
| Field engineer | Compact tracked support chassis, offset cabin, substantial articulated maintenance boom; no weapon |
| Nexus construction vehicle | Large unarmed tracked transport with a rounded cabin, folded communications dish, and packed base machinery; AI Unity uses an angular articulated carrier with a segmented array |
| Pike striker | Fast elongated six-wheel hull, paired autocannon barrels and central weapon mount; lighter and narrower than the tank |
...
The two-tile Signal laboratory has a broad circular research chamber and sensor apparatus; the two-tile Grid capacitor has four large storage packs and graphite bus bars. Show laboratory and local upgrade progress only while a project is active. Capacitor indicators show actual stored energy; power shortages dim operating lights and add small amber warning marks. Stored reserves bridge shortages before defenses shut down. Keep these operational states frozen for remembered enemy buildings.

Walls are common defensive structures for both races, built as connected one-tile segments. Keep their low armor parapets, visible joins, construction states and lower-right shadows consistent with neighboring buildings. Drag previews show every planned segment and the affordable cost; diagonal lines remain solid rather than leaving traversable corner gaps. Walls remain attackable, repairable and sellable. Do not let a hidden neighboring enemy wall change a remembered wall’s connections or shadow.
...
Building selection exposes repair and sell controls with clear cost/refund information. Repair must communicate active work and waiting for credits, stop at full health, and preserve its state through saves. Show the immediate sale refund including paid production queues; explain the command nexus restriction and retained refinery hauler value in the same compact panel. Building actions must not appear for unit selections.

Group move and attack-move orders translate the selected formation to the destination, preserving each unit's relative position wherever terrain and clearance allow. Units should visibly settle into their own positions rather than crowd the click point. Preserve those offsets when orders repeat. During travel, use Boids separation, alignment and cohesion with local detours, speed matching and temporary yielding to prevent clogs. Keep static obstacles and ordinary open-ground body spacing solid; temporary pair-specific friendly passing is reserved for otherwise impassable narrow lanes.

Movement follows direct open routes, pruning unnecessary grid waypoints while preserving exact destinations, solid corners, and deterministic save continuation. Units may rotate and move at the same time: forward travel follows the current body heading, with bounded steering and braking for sharp or obstructed turns. Avoid sideways sliding and repeated stop-turn cycles on clear routes. Combat aiming remains responsive.

Selected units show individual assigned destination brackets and restrained route segments through currently visible ground. WASD and arrows pan the camera; pointer edges and corners scroll it. Q issues attack move, H stops units. All zoom inputs use five fixed levels with a native-resolution maximum; preserve these controls and snap older saved zoom values on restoration.
