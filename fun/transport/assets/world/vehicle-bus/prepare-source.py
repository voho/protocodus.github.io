#!/usr/bin/env python3
"""Losslessly pad separately drawn vehicle frames into equal cells without clipping.

Image generation let some vehicles extend into the unused center cell. These
rectangles isolate each complete vehicle through transparent gaps. No frame is
