...
The nine house designs use generated, textured miniature artwork with distinct roofs, masonry, timber and gardens. Each environment has its own finish, including snowy tundra roofs and dry desert planting. Transparent 256 × 256 masters are downscaled into matching sprites for all three zoom levels and standard/Retina displays; night lights follow the actual windows. Existing towns receive the artwork on reload. See [house assets and generation prompts](assets/houses/README.md).
